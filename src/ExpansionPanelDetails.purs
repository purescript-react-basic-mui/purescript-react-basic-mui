...
type ExpansionPanelDetailsProps_required =
  ( 
  )
...
expansionPanelDetails :: JSX
expansionPanelDetails = _ExpansionPanelDetails
foreign import _ExpansionPanelDetails :: JSX