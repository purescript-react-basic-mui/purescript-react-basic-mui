...
type ExpansionPanelActionsProps_required =
  ( 
  )
...
expansionPanelActions :: JSX
expansionPanelActions = _ExpansionPanelActions
foreign import _ExpansionPanelActions :: JSX