module React.Basic.MUI.Toolbar where 
...
toolbarProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ToolbarProps_optional)
  => Record (attrs)
  -> ToolbarProps
toolbarProps = unsafeCoerce

type ToolbarClassKey = Foreign
