module React.Basic.MUI.StepLabel where 
...
import React.Basic.MUI.StepButton (StepButtonIcon)
import React.Basic.MUI.Stepper (Orientation)
import React.Basic.MUI.StepIcon (StepIconProps)
import React.Basic.DOM.Internal (CSS)
import React.Basic.Events (EventHandler)

type StepLabelProps_required optional =
  ( children :: JSX
  | optional )

type StepLabelProps_optional =
  ( active :: Boolean
...
stepLabelProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (StepLabelProps_optional)
  => Record (StepLabelProps_required attrs)
  -> StepLabelProps
stepLabelProps = unsafeCoerce

type StepLabelClasskey = Foreign
