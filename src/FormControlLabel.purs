module React.Basic.MUI.FormControlLabel where 
...
type FormControlLabelProps_required =
  ( control :: Foreign
  , label :: JSX
  )
...
formControlLabel :: JSX
formControlLabel = _FormControlLabel
foreign import _FormControlLabel :: JSX