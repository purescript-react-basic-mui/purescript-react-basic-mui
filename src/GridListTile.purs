module React.Basic.MUI.GridListTile where 
...
type GridListTileProps_optional =
  ( cols :: Number
  , component :: JSX
  , rows :: Number
  , hidden :: Boolean
...
gridListTileProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (GridListTileProps_optional)
  => Record (attrs)
  -> GridListTileProps
gridListTileProps = unsafeCoerce

type GridListTileClassKey = Foreign
...
gridListTile
  ...
  => Record (attrs)
  -> JSX
gridListTile = element _GridListTile
