module React.Basic.MUI.CardHeader where 
...
cardHeaderProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (CardHeaderProps_optional)
  => Record (attrs)
  -> CardHeaderProps
cardHeaderProps = unsafeCoerce

type CardHeaderClassKey = Foreign
