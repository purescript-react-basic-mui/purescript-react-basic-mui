module React.Basic.MUI.CircularProgress where 
...
type CircularProgressProps_optional =
  ( color :: Foreign
...
circularProgressProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (CircularProgressProps_optional)
  => Record (attrs)
  -> CircularProgressProps
circularProgressProps = unsafeCoerce

type CircularProgressClassKey = Foreign
