module React.Basic.MUI.FormGroup where 
...
formGroupProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (FormGroupProps_optional)
  => Record (attrs)
  -> FormGroupProps
formGroupProps = unsafeCoerce

type FormGroupClassKey = Foreign
