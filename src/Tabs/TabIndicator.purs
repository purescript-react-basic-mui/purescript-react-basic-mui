module React.Basic.MUI.Tabs.TabIndicator where 
...
foreign import data TabIndicatorProps :: Type 
...
tabIndicatorProps
  ...
  -> TabIndicatorProps
tabIndicatorProps = unsafeCoerce

type TabIndicatorClassKey = Foreign
...
tabIndicator
  ...
  => Record (TabIndicatorProps_required attrs)
  -> JSX
tabIndicator = element _TabIndicator
