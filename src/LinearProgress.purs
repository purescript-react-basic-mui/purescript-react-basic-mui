module React.Basic.MUI.LinearProgress where 
...
type LinearProgressProps_optional =
  ( color :: Foreign
  , value :: Number
  , valueBuffer :: Number
  , variant :: Foreign
...
linearProgressProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (LinearProgressProps_optional)
  => Record (attrs)
  -> LinearProgressProps
linearProgressProps = unsafeCoerce

type LinearProgressClassKey = Foreign
