module React.Basic.MUI.GridList where 
...
gridListProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (GridListProps_optional)
  => Record (attrs)
  -> GridListProps
gridListProps = unsafeCoerce

type GridListClassKey = String
