module React.Basic.MUI.DialogContent where 
...
type DialogContentProps_optional =
  ( dividers :: Boolean
  , hidden :: Boolean
  , style :: CSS
  , title :: String
...
dialogContentProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DialogContentProps_optional)
  => Record (attrs)
  -> DialogContentProps
dialogContentProps = unsafeCoerce

type DialogContentClassKey = String
...
dialogContent
  ...
  => Record (attrs)
  -> JSX
dialogContent = element _DialogContent
