module React.Basic.MUI.ListItemText where 
...
import React.Basic.MUI.Typography (TypographyProps)
import React.Basic.DOM.Internal (CSS)
import React.Basic.Events (EventHandler)

type ListItemTextProps_optional =
...
listItemTextProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ListItemTextProps_optional)
  => Record (attrs)
  -> ListItemTextProps
listItemTextProps = unsafeCoerce

type ListItemTextClassKey = Foreign
