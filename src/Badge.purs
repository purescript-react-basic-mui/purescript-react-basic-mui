module React.Basic.MUI.Badge where 
...
type BadgeProps_required optional =
  ( children :: JSX
  | optional )

type BadgeProps_optional =
  ( badgeContent :: JSX
  , color :: Foreign
  , component :: JSX
  , invisible :: Boolean
...
badgeProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (BadgeProps_optional)
  => Record (BadgeProps_required attrs)
  -> BadgeProps
badgeProps = unsafeCoerce

type BadgeClassKey = Foreign
