module React.Basic.MUI.ListSubheader where 
...
type ListSubheaderProps_optional =
  ( color :: Foreign
  , component :: JSX
...
listSubheaderProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ListSubheaderProps_optional)
  => Record (attrs)
  -> ListSubheaderProps
listSubheaderProps = unsafeCoerce

type ListSubheaderClassKey = Foreign
...
listSubheader
  ...
  => Record (attrs)
  -> JSX
listSubheader = element _ListSubheader
