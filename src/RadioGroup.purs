module React.Basic.MUI.RadioGroup where 
...
radioGroupProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (RadioGroupProps_optional)
  => Record (attrs)
  -> RadioGroupProps
radioGroupProps = unsafeCoerce

type RadioGroupClassKey = Foreign
...
radioGroup
  ...
  => Record (attrs)
  -> JSX
radioGroup = element _RadioGroup
