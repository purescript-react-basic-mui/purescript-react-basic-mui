...
type BottomNavigationActionProps_required =
  ( 
  )

type BottomNavigationActionProps_optional =
  ( icon :: Foreign
  , label :: JSX
  , onChange :: Foreign
  , onClick :: EventHandler
...
bottomNavigationAction :: JSX
bottomNavigationAction = _BottomNavigationAction
foreign import _BottomNavigationAction :: JSX