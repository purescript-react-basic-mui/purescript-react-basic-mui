module React.Basic.MUI.Stepper where 
...
type Orientation = Foreign

type StepperProps_required optional =
  ( children :: JSX
  | optional )

type StepperProps_optional =
  ( activeStep :: Number
...
stepperProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (StepperProps_optional)
  => Record (StepperProps_required attrs)
  -> StepperProps
stepperProps = unsafeCoerce

type StepperClasskey = Foreign
