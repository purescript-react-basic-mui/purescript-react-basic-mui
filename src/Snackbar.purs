module React.Basic.MUI.Snackbar where 
...
import React.Basic.MUI.SnackbarContent (SnackbarContentProps)
import React.Basic.MUI.ClickAwayListener (ClickAwayListenerProps)
import React.Basic.Events (EventHandler)
import React.Basic (element, ReactComponent, JSX)
import React.Basic.MUI.Transitions.Transition (TransitionProps)
import React.Basic.DOM.Internal (CSS)

type SnackbarOrigin_required optional =
  ( horizontal :: Foreign
  , vertical :: Foreign
  | optional )

type SnackbarOrigin_optional =
  ( 
  )

foreign import data SnackbarOrigin :: Type 

snackbarOrigin
  :: ∀ attrs attrs_
   . Union attrs attrs_ (SnackbarOrigin_optional)
  => Record (SnackbarOrigin_required attrs)
  -> SnackbarOrigin
snackbarOrigin = unsafeCoerce
...
snackbarProps
  ...
  -> SnackbarProps
snackbarProps = unsafeCoerce

type SnackbarClassKey = Foreign
