module React.Basic.MUI.MenuList where 
...
foreign import data MenuListProps :: Type 

menuListProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (MenuListProps_optional)
  => Record (attrs)
  -> MenuListProps
menuListProps = unsafeCoerce

type MenuListClassKey = Foreign
