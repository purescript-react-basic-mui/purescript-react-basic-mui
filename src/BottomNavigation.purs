module React.Basic.MUI.BottomNavigation where 
...
type BottomNavigationProps_required optional =
  ( children :: JSX
  | optional )

type BottomNavigationProps_optional =
  ( component :: JSX
  , onChange :: Foreign
  , showLabels :: Boolean
  , value :: Foreign
...
bottomNavigationProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (BottomNavigationProps_optional)
  => Record (BottomNavigationProps_required attrs)
  -> BottomNavigationProps
bottomNavigationProps = unsafeCoerce

type BottomNavigationClassKey = String
