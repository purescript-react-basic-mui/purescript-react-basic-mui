module React.Basic.MUI.CardContent where 
...
type CardContentProps_optional =
  ( component :: JSX
  , hidden :: Boolean
  , style :: CSS
  , title :: String
...
cardContentProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (CardContentProps_optional)
  => Record (attrs)
  -> CardContentProps
cardContentProps = unsafeCoerce

type CardContentClassKey = String
