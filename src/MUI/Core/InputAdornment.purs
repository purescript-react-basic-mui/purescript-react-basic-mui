...
inputAdornmentWithStyles :: ∀ required jss_ jss given. Prim.Row.Union given required (InputAdornmentPropsOptions React.Basic.DOM.Props_div) => Prim.Row.Union jss jss_ InputAdornmentClassKeyOptionsJSS => (MUI.Core.Styles.Types.Theme -> Record jss) -> Record given -> React.Basic.JSX
inputAdornmentWithStyles style = React.Basic.element (Unsafe.Coerce.unsafeCoerce MUI.Core.Styles.WithStyles.withStyles style _InputAdornment)