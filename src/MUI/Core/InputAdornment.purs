...
type InputAdornmentPropsOptions componentProps = ( children :: Array React.Basic.JSX, classes :: InputAdornmentClassKey, component :: React.Basic.ReactComponent {  | componentProps }, disablePointerEvents :: Boolean, disableTypography :: Boolean, variant :: Variant | componentProps )

type InputAdornmentPropsRequiredOptions required = ( position :: Position | required )
...
inputAdornment :: ∀ required given. Prim.Row.Union given (InputAdornmentPropsRequiredOptions required) (InputAdornmentPropsOptions React.Basic.DOM.Props_div) => Record given -> React.Basic.JSX
inputAdornment = React.Basic.element _InputAdornment

inputAdornment_component :: ∀ required given componentProps. Prim.Row.Union given (InputAdornmentPropsRequiredOptions required) (InputAdornmentPropsOptions componentProps) => Record given -> React.Basic.JSX
