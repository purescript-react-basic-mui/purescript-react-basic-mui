...
_MenuItem::forall given optionalGiven optionalMissing props required. 
...
menuItem::forall given optionalGiven optionalMissing props required. 
  Nub' (MenuItemReqPropsRow (MUI.Core.ListItem.ListItemReqPropsRow ())) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuItemPropsRow (MUI.Core.ListItem.ListItemPropsRow React.Basic.DOM.Props_li)) props =>
  Prim.Row.Union given optionalMissing props =>
...
menuItemWithStyles::forall jss_ jss given optionalGiven optionalMissing props required. 
  Nub' (MenuItemReqPropsRow (MUI.Core.ListItem.ListItemReqPropsRow ())) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuItemPropsRow (MUI.Core.ListItem.ListItemPropsRow React.Basic.DOM.Props_li)) props =>
  Prim.Row.Union given optionalMissing props =>
...
menuItemProps::forall given optionalGiven optionalMissing props required. 
  Nub' (MenuItemReqPropsRow (MUI.Core.ListItem.ListItemReqPropsRow ())) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuItemPropsRow (MUI.Core.ListItem.ListItemPropsRow React.Basic.DOM.Props_li)) props =>
  Prim.Row.Union given optionalMissing props =>
