...
menuItemPropsPartial :: ∀ options_ options. Prim.Row.Union options options_ (MenuItemPropsOptions React.Basic.DOM.Props_div) => Record options -> MenuItemPropsPartial
