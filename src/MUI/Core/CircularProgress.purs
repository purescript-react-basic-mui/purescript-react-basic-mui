...
_CircularProgress::forall given optionalGiven optionalMissing props required. 
...
circularProgress::forall given optionalGiven optionalMissing props required. 
  Nub' (CircularProgressReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CircularProgressPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
circularProgressWithStyles::forall jss_ jss given optionalGiven optionalMissing props required. 
  Nub' (CircularProgressReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CircularProgressPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
circularProgressWithStyles style props = element (withStyles' style _CircularProgress) props
  where
...
circularProgressProps::forall given optionalGiven optionalMissing props required. 
  Nub' (CircularProgressReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CircularProgressPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
