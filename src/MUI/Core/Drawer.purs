...
import MUI.Unsafe (unsafeRefOrd)
...
instance ordAnchor :: Ord Anchor where
  compare = unsafeRefOrd
...
_Drawer::forall given optionalGiven optionalMissing props required. 
...
drawer::forall given optionalGiven optionalMissing props required. 
  Nub' (DrawerReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (DrawerPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
drawerWithStyles::forall jss_ jss given optionalGiven optionalMissing props required. 
  Nub' (DrawerReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (DrawerPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
drawerProps::forall given optionalGiven optionalMissing props required. 
  Nub' (DrawerReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (DrawerPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
