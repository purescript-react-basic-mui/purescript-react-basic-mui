...
type SwipeableDrawerPropsOptions componentProps = ( "SwipeAreaProps" :: Foreign.Foreign, children :: Array React.Basic.JSX, disableBackdropTransition :: Boolean, disableDiscovery :: Boolean, disableSwipeToOpen :: Boolean, hysteresis :: Number, minFlingVelocity :: Number, onClose :: React.Basic.Events.EventHandler, onOpen :: React.Basic.Events.EventHandler, swipeAreaWidth :: Number | componentProps )

type SwipeableDrawerPropsRequiredOptions required = ( open :: Boolean | required )
...
swipeableDrawer :: ∀ required given. Prim.Row.Union given (SwipeableDrawerPropsRequiredOptions required) (SwipeableDrawerPropsOptions (MUI.Core.Drawer.DrawerPropsOptions React.Basic.DOM.Props_div)) => Record given -> React.Basic.JSX
swipeableDrawer = React.Basic.element _SwipeableDrawer

swipeableDrawer_component :: ∀ required given componentProps. Prim.Row.Union given (SwipeableDrawerPropsRequiredOptions required) (SwipeableDrawerPropsOptions componentProps) => Record given -> React.Basic.JSX
