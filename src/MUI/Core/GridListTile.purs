...
gridListTileWithStyles :: ∀ required jss_ jss given. Prim.Row.Union given required (GridListTilePropsOptions React.Basic.DOM.Props_li) => Prim.Row.Union jss jss_ GridListTileClassKeyOptionsJSS => (MUI.Core.Styles.Types.Theme -> Record jss) -> Record given -> React.Basic.JSX
gridListTileWithStyles style = React.Basic.element (Unsafe.Coerce.unsafeCoerce MUI.Core.Styles.WithStyles.withStyles style _GridListTile)