...
cardContentWithStyles :: ∀ required jss_ jss given. Prim.Row.Union given required (CardContentPropsOptions React.Basic.DOM.Props_div) => Prim.Row.Union jss jss_ CardContentClassKeyOptionsJSS => (MUI.Core.Styles.Types.Theme -> Record jss) -> Record given -> React.Basic.JSX
cardContentWithStyles style = React.Basic.element (Unsafe.Coerce.unsafeCoerce MUI.Core.Styles.WithStyles.withStyles style _CardContent)