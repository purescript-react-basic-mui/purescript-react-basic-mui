...
type ButtonBasePropsOptions componentProps = ( "TouchRippleProps" :: MUI.Core.ButtonBase.TouchRipple.TouchRippleProps, action :: Foreign.Foreign, buttonRef :: Foreign.Foreign, centerRipple :: Boolean, classes :: ButtonBaseClassKey, color :: String, disableRipple :: Boolean, disabled :: Boolean, focusRipple :: Boolean, focusVisibleClassName :: String, onFocusVisible :: React.Basic.Events.EventHandler, "type" :: Type_ | componentProps )

type ButtonBasePropsRequiredOptions required = ( children :: Array React.Basic.JSX | required )
...
buttonBase :: ∀ required given. Prim.Row.Union given (ButtonBasePropsRequiredOptions required) (ButtonBasePropsOptions (ButtonBasePropsOptions React.Basic.DOM.Props_button)) => Record given -> React.Basic.JSX
buttonBase = React.Basic.element _ButtonBase

buttonBase_component :: ∀ required given componentProps. Prim.Row.Union given (ButtonBasePropsRequiredOptions required) (ButtonBasePropsOptions componentProps) => Record given -> React.Basic.JSX
