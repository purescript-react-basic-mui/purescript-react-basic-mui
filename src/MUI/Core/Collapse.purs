...
_Collapse::forall given optionalGiven optionalMissing props required. 
...
collapse::forall given optionalGiven optionalMissing props required. 
  Nub' (CollapseReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CollapsePropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
collapseWithStyles::forall jss_ jss given optionalGiven optionalMissing props required. 
  Nub' (CollapseReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CollapsePropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
collapseWithStyles style props = element (withStyles' style _Collapse) props
  where
...
collapseProps::forall given optionalGiven optionalMissing props required. 
  Nub' (CollapseReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (CollapsePropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
