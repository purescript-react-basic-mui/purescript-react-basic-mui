...
badgeWithStyles :: ∀ required jss_ jss given. Prim.Row.Union given required (BadgePropsOptions React.Basic.DOM.Props_div) => Prim.Row.Union jss jss_ BadgeClassKeyOptionsJSS => (MUI.Core.Styles.Types.Theme -> Record jss) -> Record given -> React.Basic.JSX
badgeWithStyles style = React.Basic.element (Unsafe.Coerce.unsafeCoerce MUI.Core.Styles.WithStyles.withStyles style _Badge)