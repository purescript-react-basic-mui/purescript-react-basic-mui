...
_Menu::forall given optionalGiven optionalMissing props required. 
...
menu::forall given optionalGiven optionalMissing props required. 
  Nub' (MenuReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
menuWithStyles::forall jss_ jss given optionalGiven optionalMissing props required. 
  Nub' (MenuReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
...
menuProps::forall given optionalGiven optionalMissing props required. 
  Nub' (MenuReqPropsRow ()) required =>
  Prim.Row.Union required optionalGiven given =>
  Nub' (MenuPropsRow React.Basic.DOM.Props_div) props =>
  Prim.Row.Union given optionalMissing props =>
