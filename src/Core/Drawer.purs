module React.Basic.MUI.Core.Drawer where 
...
import React.Basic.MUI.Core.Slide (SlideProps)
...
drawerProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DrawerProps_optional )
  => Record (attrs)
  -> DrawerProps
drawerProps = unsafeCoerce

type DrawerClassKey = Foreign
