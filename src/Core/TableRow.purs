module React.Basic.MUI.Core.TableRow where 
...
tableRowProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableRowProps_optional )
  => Record (attrs)
  -> TableRowProps
tableRowProps = unsafeCoerce

type TableRowBaseProps = Foreign

type TableRowClassKey = Foreign
