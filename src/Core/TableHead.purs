module React.Basic.MUI.Core.TableHead where 
...
tableHeadProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableHeadProps_optional )
  => Record (attrs)
  -> TableHeadProps
tableHeadProps = unsafeCoerce

type TableHeadClassKey = String

type TableHeadBaseProps = Foreign
