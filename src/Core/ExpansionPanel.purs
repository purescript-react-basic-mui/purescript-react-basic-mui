module React.Basic.MUI.Core.ExpansionPanel where 
...
type ExpansionPanelProps_optional =
...
expansionPanelProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ExpansionPanelProps_optional )
  => Record (attrs)
  -> ExpansionPanelProps
expansionPanelProps = unsafeCoerce

type ExpansionPanelClassKey = Foreign
