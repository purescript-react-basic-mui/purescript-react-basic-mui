module React.Basic.MUI.Core.FilledInput where 
...
type FilledInputProps_optional =
...
foreign import data FilledInputProps :: Type 

filledInputProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (FilledInputProps_optional )
  => Record (attrs)
  -> FilledInputProps
filledInputProps = unsafeCoerce

type FilledInputClassKey = Foreign
...
filledInput
  ...
  => Record (attrs)
  -> JSX
filledInput = element _FilledInput
