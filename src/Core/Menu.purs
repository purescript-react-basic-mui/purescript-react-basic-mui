module React.Basic.MUI.Core.Menu where 
...
import React.Basic.MUI.Core.Popover (PopoverReference, PopoverPosition, PopoverActions, PopoverOrigin, PopoverProps)
import React.Basic.MUI.Core.Transitions.Transition (TransitionProps)
import React.Basic.DOM.Internal (CSS)
import React.Basic (element, ReactComponent, JSX)
import React.Basic.Events (EventHandler)
import React.Basic.MUI.Core.Portal (PortalProps)
import React.Basic.MUI.Core.Backdrop (BackdropProps)
import React.Basic.MUI.Core.Modal (ModalProps)

type MenuProps_required  optional =
  ( open :: Boolean
  | optional )

type MenuProps_optional =
  ( disableAutoFocusItem :: Boolean
  , "MenuListProps" :: Foreign
  , "PaperProps" :: Foreign
  , "PopoverClasses" :: Foreign
...
menuProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (MenuProps_optional )
  => Record (MenuProps_required attrs)
  -> MenuProps
menuProps = unsafeCoerce

type MenuClassKey = String
