module React.Basic.MUI.Core.Select where 
...
selectProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (SelectProps_optional )
  => Record (attrs)
  -> SelectProps
selectProps = unsafeCoerce

type SelectClassKey = Foreign
