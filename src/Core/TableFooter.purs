module React.Basic.MUI.Core.TableFooter where 
...
type TableFooterProps_optional =
  ( component :: JSX
  , hidden :: Boolean
  , style :: CSS
  , title :: String
...
tableFooterProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableFooterProps_optional )
  => Record (attrs)
  -> TableFooterProps
tableFooterProps = unsafeCoerce

type TableFooterClassKey = String

type TableFooterBaseProps = Foreign
