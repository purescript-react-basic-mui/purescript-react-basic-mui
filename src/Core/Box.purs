module React.Basic.MUI.Core.Box where 
...
type BoxStyleFunction = ComposedStyleFunction Foreign

type SystemProps = Foreign

type ElementProps = Foreign
...
boxProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (BoxProps_optional )
  => Record (attrs)
  -> BoxProps
