module React.Basic.MUI.Core.Tooltip where 
...
import React.Basic.MUI.Core.Popper (PopperProps)
...
foreign import data TooltipProps :: Type 
...
tooltipProps
  ...
  -> TooltipProps
tooltipProps = unsafeCoerce

type TooltipClassKey = Foreign
