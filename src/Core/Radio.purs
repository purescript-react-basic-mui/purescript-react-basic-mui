module React.Basic.MUI.Core.Radio where 
...
radioProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (RadioProps_optional )
  => Record (attrs)
  -> RadioProps
radioProps = unsafeCoerce

type RadioClassKey = Foreign
