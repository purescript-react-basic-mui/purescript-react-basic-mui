module React.Basic.MUI.Core.NativeSelect where 
...
type NativeSelectProps_optional =
  ( "IconComponent" :: JSX
  , input :: JSX
  , value :: Foreign
  , variant :: Foreign
...
nativeSelectProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (NativeSelectProps_optional )
  => Record (attrs)
  -> NativeSelectProps
nativeSelectProps = unsafeCoerce

type NativeSelectClassKey = Foreign
...
nativeSelect
  ...
  => Record (attrs)
  -> JSX
nativeSelect = element _NativeSelect
