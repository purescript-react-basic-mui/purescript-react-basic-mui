module React.Basic.MUI.Core.Table where 
...
tableProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableProps_optional )
  => Record (attrs)
  -> TableProps
tableProps = unsafeCoerce

type TableBaseProps = Foreign

type Padding = Foreign

type Size = Foreign

type TableClassKey = String
