module React.Basic.MUI.Core.TableCell where 
...
tableCellProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableCellProps_optional )
  => Record (attrs)
  -> TableCellProps
tableCellProps = unsafeCoerce

type TableCellBaseProps = Foreign

type Padding = Foreign

type Size = Foreign

type SortDirection = Foreign

type TableCellClassKey = Foreign
