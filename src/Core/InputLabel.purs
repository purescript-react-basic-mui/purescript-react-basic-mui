module React.Basic.MUI.Core.InputLabel where 
...
inputLabelProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (InputLabelProps_optional )
  => Record (attrs)
  -> InputLabelProps
inputLabelProps = unsafeCoerce

type InputLabelClassKey = Foreign
...
inputLabel
  ...
  => Record (attrs)
  -> JSX
inputLabel = element _InputLabel
