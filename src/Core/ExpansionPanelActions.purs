module React.Basic.MUI.Core.ExpansionPanelActions where 
...
type ExpansionPanelActionsProps_optional =
  ( hidden :: Boolean
  , style :: CSS
  , title :: String
  , dir :: String
...
expansionPanelActionsProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ExpansionPanelActionsProps_optional )
  => Record (attrs)
  -> ExpansionPanelActionsProps
expansionPanelActionsProps = unsafeCoerce

type ExpansionPanelActionsClassKey = Foreign
...
expansionPanelActions
  ...
  => Record (attrs)
  -> JSX
expansionPanelActions = element _ExpansionPanelActions
