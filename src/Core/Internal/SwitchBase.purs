module React.Basic.MUI.Core.Internal.SwitchBase where 
...
import React.Basic.MUI.Core.ButtonBase (ButtonBaseActions)
...
foreign import data SwitchBaseProps :: Type 
...
switchBaseProps
  ...
  -> SwitchBaseProps
switchBaseProps = unsafeCoerce

type SwitchBaseClassKey = Foreign
...
switchBase
  ...
  => Record (SwitchBaseProps_required attrs)
  -> JSX
switchBase = element _SwitchBase
