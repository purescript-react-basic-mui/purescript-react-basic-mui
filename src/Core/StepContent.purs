module React.Basic.MUI.Core.StepContent where 
...
type StepContentProps_required  optional =
  ( children :: JSX
  | optional )

type StepContentProps_optional =
  ( active :: Boolean
...
stepContentProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (StepContentProps_optional )
  => Record (StepContentProps_required attrs)
  -> StepContentProps
stepContentProps = unsafeCoerce

type StepContentClasskey = Foreign
...
stepContent
  ...
  => Record (StepContentProps_required attrs)
  -> JSX
stepContent = element _StepContent
