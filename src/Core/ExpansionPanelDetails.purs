module React.Basic.MUI.Core.ExpansionPanelDetails where 
...
type ExpansionPanelDetailsProps_optional =
  ( hidden :: Boolean
  , style :: CSS
  , title :: String
  , dir :: String
...
expansionPanelDetailsProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ExpansionPanelDetailsProps_optional )
  => Record (attrs)
  -> ExpansionPanelDetailsProps
expansionPanelDetailsProps = unsafeCoerce

type ExpansionPanelDetailsClassKey = String
...
expansionPanelDetails
  ...
  => Record (attrs)
  -> JSX
expansionPanelDetails = element _ExpansionPanelDetails
