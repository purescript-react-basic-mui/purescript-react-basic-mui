module React.Basic.MUI.Core.StepConnector where 
...
type StepConnectorIcon = Foreign

type StepConnectorProps_optional =
  ( active :: Boolean
...
stepConnectorProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (StepConnectorProps_optional )
  => Record (attrs)
  -> StepConnectorProps
stepConnectorProps = unsafeCoerce

type StepConnectorClasskey = Foreign
...
stepConnector
  ...
  => Record (attrs)
  -> JSX
stepConnector = element _StepConnector
