module React.Basic.MUI.Core.TableBody where 
...
tableBodyProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (TableBodyProps_optional )
  => Record (attrs)
  -> TableBodyProps
tableBodyProps = unsafeCoerce

type TableBodyClassKey = String

type TableBodyBaseProps = Foreign
