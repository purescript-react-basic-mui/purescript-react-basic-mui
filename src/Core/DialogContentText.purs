module React.Basic.MUI.Core.DialogContentText where 
...
import React.Basic.MUI.Core.Typography (Style)

type DialogContentTextProps_optional =
  ( hidden :: Boolean
  , style :: CSS
  , title :: String
  , dir :: String
...
dialogContentTextProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DialogContentTextProps_optional )
  => Record (attrs)
  -> DialogContentTextProps
dialogContentTextProps = unsafeCoerce

type DialogContentTextClassKey = String
...
dialogContentText
  ...
  => Record (attrs)
  -> JSX
dialogContentText = element _DialogContentText
