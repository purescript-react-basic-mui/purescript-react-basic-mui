module React.Basic.MUI.CardActions where 
...
type CardActionsProps_optional =
...
cardActionsProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (CardActionsProps_optional)
  => Record (attrs)
  -> CardActionsProps
cardActionsProps = unsafeCoerce

type CardActionsClassKey = Foreign
