module React.Basic.MUI.DialogActions where 
...
type DialogActionsProps_optional =
...
dialogActionsProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DialogActionsProps_optional)
  => Record (attrs)
  -> DialogActionsProps
dialogActionsProps = unsafeCoerce

type DialogActionsClassKey = Foreign
...
dialogActions
  ...
  => Record (attrs)
  -> JSX
dialogActions = element _DialogActions
