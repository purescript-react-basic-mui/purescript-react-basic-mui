module React.Basic.MUI.Dialog where 
...
type DialogProps_required optional =
  ( open :: Boolean
  | optional )

type DialogProps_optional =
  ( children :: JSX
  , fullScreen :: Boolean
  , fullWidth :: Boolean
  , maxWidth :: Foreign
...
dialogProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DialogProps_optional)
  => Record (DialogProps_required attrs)
  -> DialogProps
dialogProps = unsafeCoerce

type DialogClassKey = Foreign
