...
type PopoverProps  =
  { action :: Foreign
  , anchorEl :: Foreign
  , anchorOrigin :: Foreign
  , anchorPosition :: Foreign
  , anchorReference :: Foreign
  , children :: JSX
  , elevation :: Number
