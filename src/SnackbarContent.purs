module React.Basic.MUI.SnackbarContent where 
...
type SnackbarContentProps_optional =
  ( action :: JSX
  , message :: JSX
  , square :: Boolean
  , hidden :: Boolean
...
snackbarContentProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (SnackbarContentProps_optional)
  => Record (attrs)
  -> SnackbarContentProps
snackbarContentProps = unsafeCoerce

type SnackbarContentClassKey = Foreign
...
snackbarContent
  ...
  => Record (attrs)
  -> JSX
snackbarContent = element _SnackbarContent
