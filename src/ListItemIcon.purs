module React.Basic.MUI.ListItemIcon where 
...
type ListItemIconProps_required optional =
  ( children :: Foreign
  | optional )

type ListItemIconProps_optional =
  ( hidden :: Boolean
  , style :: CSS
  , title :: String
  , dir :: String
...
listItemIconProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (ListItemIconProps_optional)
  => Record (ListItemIconProps_required attrs)
  -> ListItemIconProps
listItemIconProps = unsafeCoerce

type ListItemIconClassKey = String
