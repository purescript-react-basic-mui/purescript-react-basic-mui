module React.Basic.MUI.DialogTitle where 
...
type DialogTitleProps_optional =
...
dialogTitleProps
  :: ∀ attrs attrs_
   . Union attrs attrs_ (DialogTitleProps_optional)
  => Record (attrs)
  -> DialogTitleProps
dialogTitleProps = unsafeCoerce

type DialogTitleClassKey = String
...
dialogTitle
  ...
  => Record (attrs)
  -> JSX
dialogTitle = element _DialogTitle
